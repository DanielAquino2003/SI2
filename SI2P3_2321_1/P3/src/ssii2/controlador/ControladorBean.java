...
public class ControladorBean implements Serializable {
    ...
    public String enviarVoto() {
	    ...
	    if (dao.compruebaCenso(this.voto.getCenso()) == false) {
			...
			String error_msg = "¡El ciudadano no se encuentra en el censo!" + this.voto.getCenso().getNumeroDNI();
		...
		voto.setInstancia(System.getProperty("com.sun.aas.instanceName"));

		try {
			voto.setIp(java.net.InetAddress.getLocalHost().getHostAddress());
		} catch (Exception e) {
